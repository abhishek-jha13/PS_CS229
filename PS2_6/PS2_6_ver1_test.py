...
T = 10
alpha = [ 0.42648979, 0.40682636, 0.32560432, 0.32423662, 0.28536227, 0.29267311, 0.28450168, 0.27338648, 0.27196883]
features = [0, 6, 9, 17, 11, 9, 15, 9, 14]
...
for index in range(0, len(testing_data)):
	...
	if testing_data[18][index] <= medians[3]:
		...
		H[index] += alpha[3]	
	if testing_data[12][index] <= medians[4]:
		H[index] += (-1) * alpha[4]
	else:
		H[index] += alpha[4]	
	if testing_data[10][index] <= medians[5]:
		...
		H[index] += alpha[5]	
	if testing_data[16][index] <= medians[6]:
		H[index] += (-1) * alpha[6]
	else:
		H[index] += alpha[6]	
	if testing_data[10][index] <= medians[7]:
		H[index] += (-1) * alpha[7]
	else:
		H[index] += alpha[7]	
	if testing_data[15][index] <= medians[8]:
		H[index] += (-1) * alpha[8]
	else:
		H[index] += alpha[8]
